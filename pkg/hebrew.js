...
export function extract_root_json(word) {
    ...
    try {
        ...
        const len0 = WASM_VECTOR_LEN;
        wasm.extract_root_json(retptr, ptr0, len0);
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
        deferred2_0 = r0;
        deferred2_1 = r1;
...
export function decompose_text(text) {
    ...
    try {
        ...
        const len0 = WASM_VECTOR_LEN;
        wasm.decompose_text(retptr, ptr0, len0);
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
        deferred2_0 = r0;
        deferred2_1 = r1;
...
export function generate_narrative_wasm(word) {
    ...
    try {
        ...
        const ptr0 = passStringToWasm0(word, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.generate_narrative_wasm(retptr, ptr0, len0);
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
        deferred2_0 = r0;
        deferred2_1 = r1;
...
export function decompose_word(word) {
    ...
    try {
        ...
        const ptr0 = passStringToWasm0(word, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.decompose_word(retptr, ptr0, len0);
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
        deferred2_0 = r0;
        deferred2_1 = r1;
...
async function __wbg_init(input) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('hebrew_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
